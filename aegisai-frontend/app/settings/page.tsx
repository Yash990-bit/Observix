          ...
          <div className="space-y-8 max-w-6xl mx-auto pb-16">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4 border-b border-white/5 pb-6">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">Configure security credentials and monitor microservice health parameters.</p>
              </div>

              <button
                onClick={loadHealth}
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 border border-white/10 text-xs font-semibold text-slate-200 hover:text-white hover:bg-white/10 transition"
              >
            ...
            <div className="glass-panel rounded-2xl p-6 border border-border/80 space-y-4">
              <h3 className="font-bold text-sm text-slate-200 uppercase tracking-wider text-cyan-400">Cluster Services Matrix</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="glass-panel rounded-2xl p-6 border border-border/80 space-y-4">
                <h3 className="font-bold text-sm text-slate-200 uppercase tracking-wider text-cyan-400">SaaS Access Control</h3>
              ...
              <div className="glass-panel rounded-2xl p-6 border border-border/80 space-y-4">
                <h3 className="font-bold text-sm text-slate-200 uppercase tracking-wider text-cyan-400">Cluster Telemetry Performance</h3>
                <div className="space-y-2 text-xs">
                  <div className="p-3 rounded-xl bg-slate-900/40 border border-white/5 flex items-center justify-between">
            ...
            <div className="glass-panel rounded-2xl p-6 border border-cyan-500/20 space-y-5 bg-gradient-to-r from-slate-950 to-indigo-950/20">
              <div className="flex items-center justify-between flex-wrap gap-4 border-b border-white/5 pb-4">
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-lg bg-gradient-to-r from-cyan-500 to-indigo-600 text-white font-bold text-xs shadow-lg shadow-cyan-500/20 hover:brightness-110 transition-all"
                >
